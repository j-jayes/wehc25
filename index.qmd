...
::: {.column width="33%"}
[![](assets/sponsors/handelsbanken.png){width=80px}](https://www.handelsbankensforskningsstiftelser.se/)
:::

::: {.column width="33%"}
[![](assets/sponsors/riksbanken.png){width=80px}](https://www.rj.se/)
:::

::: {.column width="33%"}
[![](assets/sponsors/wallenberg.png){width=80px}](https://www.wallenberg.org/)
:::
...
::: {.column width="33%"}
[![](assets/sponsors/lundskommun.png){width=80px}](https://lund.se/)
:::

::: {.column width="33%"}
[![](assets/sponsors/regionskane.png){width=80px}](https://www.skane.se/)
:::

::: {.column width="33%"}
[![](assets/sponsors/lusem.png){width=80px}](https://www.lusem.lu.se/)
:::
